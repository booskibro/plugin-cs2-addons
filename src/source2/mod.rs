...
/// from these; a plugin whose shared assembly is missing throws during load,
/// and CounterStrikeSharp then keeps a context with no plugin instance —
/// which makes every later `css_plugins load` fail.
pub const CSS_SHARED_DIR: &str = "addons/counterstrikesharp/shared";
